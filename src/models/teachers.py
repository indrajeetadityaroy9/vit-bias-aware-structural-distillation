...
# Layer count lookup for DINO/DINOv2 models
DINO_NUM_LAYERS = {
    # DINOv2 models
    'dinov2_vits14': 12,
    'dinov2_vitb14': 12,
...
def load_dino_teacher(teacher_type, model_name, device):
    ...
    if model_name not in DINO_EMBED_DIMS:
        raise ValueError(f"Unknown model: {model_name}. Supported: {list(DINO_EMBED_DIMS.keys())}")
