...
1. Global defaults (configs/defaults.yaml)
2. Specific config (e.g., configs/cifar10/baselines/deit_tiny.yaml)
...
class SelfSupervisedDistillationConfig:
    ...
    def __init__(
        ...
        use_pooled_correlation=True,        # Use patch-mean pooling to avoid O(N^2)
